...
urlpatterns = [
    ...
    path(
        "parts-of-speech/",
        views.ListCreatePartOfSpeechView.as_view(),
        name="parts_of_speech",
    ),
    path(
        "parts-of-speech/<str:abbr>/",
        views.RetrieveUpdateDestroyPartOfSpeechView.as_view(),
        name="part_of_speech",
    ),
    # Words
    ...
    path(
        "<str:lang>/<str:word>/history/",
        views.ListWordHistoryView.as_view(),
        name="word_history",
    ),
    path(
        "<str:lang>/<str:word>/votes/", ListCreateVoteView.as_view(), name="word_votes"
    ),
]
