...
class Definition(models.Model):
    dict_entry = models.ForeignKey(DictEntry, on_delete=models.CASCADE, related_name="definitions")
    lang = models.ForeignKey(Language, on_delete=models.PROTECT, related_name="definitions")
    description = models.TextField(max_length=512)
    contributor = models.ForeignKey(User, on_delete=models.PROTECT, related_name="definitions")
