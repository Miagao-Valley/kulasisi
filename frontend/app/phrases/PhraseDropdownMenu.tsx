...
export default function PhraseDropdownMenu({ phrase, revisions, setIsEditing }: Props) {
  const auth = useAuth();
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        <DropdownMenuGroup>
          <DropdownMenuItem className="hover:cursor-pointer" onClick={() => copyLinkToClipboard(`/phrases/${phrase.id}/`)}>
            Copy link
          </DropdownMenuItem>
