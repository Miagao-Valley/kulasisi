...
export default function TranslationDropdownMenu({ translation, revisions, setIsEditing }: Props) {
  const auth = useAuth();
      ...
      <DropdownMenuContent className="w-56">
        <DropdownMenuGroup>
          <DropdownMenuItem
            ...
            onClick={() => copyLinkToClipboard(`/phrases/${translation.phrase}?tab=translations#${translation.id}`)}
          >
            Copy link
          </DropdownMenuItem>
            ...
            <>
              ...
              <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                <AlertDialog>
                  ...
                  <DeleteTranslationModal phraseId={translation.phrase} id={translation.id} />
                </AlertDialog>
              </DropdownMenuItem>
            </>
          )}
