...
export default function DefinitionDropdownMenu({ definition, revisions, setIsEditing }: Props) {
  const auth = useAuth();
      ...
      <DropdownMenuContent className="w-56">
        <DropdownMenuGroup>
          <DropdownMenuItem
            ...
            onClick={() => copyLinkToClipboard(`/dictionary/${definition.word}?tab=definitions#${definition.id}`)}>
            Copy link
          </DropdownMenuItem>
