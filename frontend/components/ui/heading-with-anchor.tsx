  ...
  return (
    ...
    >
      ...
      <Link href={`#${anchor}`} onClick={copyToClipboard}>
        <LinkIcon className="text-gray-600 hover:text-gray-400 max-w-5" />
      </Link>
    </div>
  );
};
...
const headingVariants = cva('font-bold', {
  variants: {
    variant: {
      ...
      h2: 'leading-14 text-2xl lg:text-3xl mb-4',
      h3: 'leading-10 text-xl lg:text-2xl mb-3',
      h4: 'leading-8 text-lg lg:text-xl mb-2',
      h5: 'leading-8 text-base lg:text-lg mb-1',
